...
const spotLight = new THREE.SpotLight(0x78ff00, 0.5, 10, Math.PI * 0.1, 0.25, 3)
...
const directionalLightHelepr = new THREE.DirectionalLightHelper(directionalLight, 0.2)
scene.add(directionalLightHelepr)
